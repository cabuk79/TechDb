...
GO
PRINT N'Creating Table [dbo].[MetalStamp]...';
...
CREATE TABLE [dbo].[MetalStamp] (
    ...
    CONSTRAINT [PK_MetalStamp] PRIMARY KEY CLUSTERED ([MetalCode] ASC, [StampCode] ASC)
);


GO
PRINT N'Creating Table [dbo].[Stamps]...';
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[MetalStamp]...';


GO
ALTER TABLE [dbo].[MetalStamp] WITH NOCHECK
    ADD FOREIGN KEY ([MetalCode]) REFERENCES [dbo].[MetalComponents] ([Code]);
...
GO
ALTER TABLE [dbo].[MetalStamp] WITH NOCHECK
    ADD FOREIGN KEY ([StampCode]) REFERENCES [dbo].[Stamps] ([Code]);
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.MetalStamp'))
               AND [type] IN (N'F', N'C')
