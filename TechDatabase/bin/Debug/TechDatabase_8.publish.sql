...
GO
PRINT N'Creating Table [dbo].[MetalPrint]...';
...
CREATE TABLE [dbo].[MetalPrint] (
    ...
    CONSTRAINT [PK_MetalPrint] PRIMARY KEY CLUSTERED ([MetalCode] ASC, [PrintCode] ASC)
);


GO
PRINT N'Creating Table [dbo].[Prints]...';
...
GO
PRINT N'Creating Foreign Key unnamed constraint on [dbo].[MetalPrint]...';


GO
ALTER TABLE [dbo].[MetalPrint] WITH NOCHECK
...
GO
ALTER TABLE [dbo].[MetalPrint] WITH NOCHECK
    ADD FOREIGN KEY ([PrintCode]) REFERENCES [dbo].[Prints] ([Code]);
...
DECLARE tableconstraintnames CURSOR LOCAL FORWARD_ONLY
    FOR SELECT SCHEMA_NAME([schema_id]),
               ...
               0
        FROM   [sys].[objects]
        WHERE  [parent_object_id] IN (OBJECT_ID(N'dbo.MetalPrint'))
               AND [type] IN (N'F', N'C')
